...
const Footer = () => {
    return (
        ...
        <footer className='bg-slate-100 shadow-lg  w-full py-8 mt-8'>
            <div className='max-w-screen-xl mx-auto px-4'>
                <div className=' flex max-w-xs mx-auto items-center justify-between'>
                    <a
                        href='https://facebook.com/md.ra.rimon' target="_blank" rel="noopener noreferrer"
                    ...
                    <a
                        href='https://twitter.com/md-ra-rimon' target="_blank" rel="noopener noreferrer"
                        className='text-gray-400 hover:text-gray-800 transition-colors duration-200'
                    >
                        <svg
                            width='20'
                    ...
                    <a
                        href='https://github.com/mdrashadul-rimon' target="_blank" rel="noopener noreferrer"
                        className='text-gray-400 hover:text-gray-800 transition-colors duration-200'
                    >
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                    ...
                    <a
                        href='https://linkedin.com/in/md-rashadulalam/' target="_blank" rel="noopener noreferrer"
                        className='text-gray-400 hover:text-gray-800 transition-colors duration-200'
                    >
                        <svg
                            width='20'
